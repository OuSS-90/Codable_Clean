...
class AnimeService {
    ...
    func getAnimeList(completion: @escaping (_ result: Result<Animes.List.Response,Error>) -> Void) {
        ...
        URLSession.shared.dataTask(with: url) { (data, response, error) in
            ...
            do {
                let response = try JSONDecoder().decode(Animes.List.Response.self, from: data)
